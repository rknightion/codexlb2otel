...
- [x] #4 The dashboard's Errors tab upstream-diagnostic panels default to a window in which the signal is expected to be visible, and docs/dashboards.md says why
<!-- AC:END -->
