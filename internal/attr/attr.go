...
var registry = []Field{
	...
	{Key: ClientGroup, Class: Bounded, Cap: 8,
		Observed: []string{"codex-tui", "codex_exec", "Codex Desktop", "curl", "Python-urllib", "codex_cli_rs"},
		Of:       func(t *turn.Turn) string { return t.ClientGroup }},
	{Key: ConnectionKind, Class: Bounded, Cap: 4, Observed: []string{"normal", "prewarm"},
		Of: func(t *turn.Turn) string { return t.ConnectionKind }},
	{Key: FailurePhase, Class: Bounded, Cap: 4, ContentOnly: true, Observed: []string{"upstream", "downstream"},
		Of: func(t *turn.Turn) string { return t.FailurePhase }},
