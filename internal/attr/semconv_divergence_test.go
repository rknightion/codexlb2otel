...
var semconvJustified = map[string]string{
	...
	RootTurnID:                       "logical root grouping has no GenAI semantic-convention equivalent",
	TurnMetadataAgentName:            "user-chosen subagent name has no GenAI semantic-convention equivalent",
	SandboxMode:                      "Codex sandbox policy has no GenAI semantic-convention equivalent",
	WindowNumber:                     "local window ordinal has no GenAI semantic-convention equivalent",
	PromptCacheMode:                  "server cache mode has no GenAI semantic-convention equivalent",
	PromptCacheTTL:                   "cache TTL seconds have no GenAI semantic-convention equivalent",
	PromptCacheDiagnostic:            "server cache diagnostic has no GenAI semantic-convention equivalent",
	UsageAttributionInputTokens:      "partial attribution accounting must not overwrite the response-level GenAI usage key",
	UsageAttributionOutputTokens:     "partial attribution accounting must not overwrite the response-level GenAI usage key",
	UsageAttributionCacheReadTokens:  "partial attribution accounting must not overwrite the response-level GenAI usage key",
	UsageAttributionCacheWriteTokens: "partial attribution accounting must not overwrite the response-level GenAI usage key",
